let extensionIndexURL = "https://api.github.com/repos/cmlo/mangoblock-extension/contents/index.json";
...
let updateExtensionScripts = async (extensionLocalPath) => {
